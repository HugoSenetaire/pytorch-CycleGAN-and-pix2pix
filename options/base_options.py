...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--image_dir', type=str, default='', help='image are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='bilinear_gan', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization | bilinear_gan]')
