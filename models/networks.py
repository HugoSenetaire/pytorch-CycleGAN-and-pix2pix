...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'resnet_9blocks':
        net = ResnetGeneratorBilinear(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=9, dim_year=9)
    elif netG == 'resnet_6blocks':
        net = ResnetGeneratorBilinear(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout, n_blocks=6, dim_year=9)
    # elif netG == 'unet_128':
...
class ResnetGeneratorBilinear(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, input_size = 256, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', dim_year = 9):
        ...
        self.bilinear1 = nn.Bilinear(total_input,self.dim_year,total_input)
